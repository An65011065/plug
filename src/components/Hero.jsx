    ...
    return (
        ...
        >
            ...
            <div className="relative z-10 text-center px-6 max-w-4xl mx-auto">
                <h1 className="text-5xl md:text-7xl font-bold text-white mb-6 bg-red-500">
                    Welcome to{" "}
                ...
                <p className="text-xl md:text-2xl text-gray-300 mb-8 leading-relaxed">
                    A modern, fast, and beautiful React application built with
                    Tailwind CSS. Experience the power of modern web
                    development.
                </p>
